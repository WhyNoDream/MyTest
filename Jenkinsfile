...
workpath="/var/testpath";///share/wms-jenkins
dllpath="/var/testpath/lib";//share/wms-jenkins/lib
version="v3.1";
...
mybuildpath="${workpath}/MyTest/src/Services/UserService";//"${workpath}/${params.buildpath}";//执行编译目录 例如 /share/wms/src/Api/WMS.WebApi
